...
class JaikissanButton extends StatelessWidget {
  final String label;
...
class JaikissanCard extends StatelessWidget {
  final Widget child;
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: color ?? JaikissanTheme.beige,
          borderRadius: BorderRadius.circular(20),
          border: Border.all(color: const Color(0xFFCDC9A5), width: 1.5),
          boxShadow: [
            BoxShadow(
              color: JaikissanTheme.emerald.withOpacity(0.06),
              blurRadius: 12,
...
class JaikissanGlassCard extends StatelessWidget {
  final Widget child;
  final EdgeInsets? padding;
  final VoidCallback? onTap;

  const JaikissanGlassCard({
    super.key,
    required this.child,
    this.padding,
    this.onTap,
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: JaikissanTheme.emerald.withOpacity(0.72),
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
...
class JaikissanTextField extends StatelessWidget {
  final String label;
  final String? hint;
  final bool obscure;
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: prefixIcon != null
            ? Icon(prefixIcon, color: JaikissanTheme.inkLight, size: 20)
            : null,
        suffixIcon: suffix,
      ),
    );
