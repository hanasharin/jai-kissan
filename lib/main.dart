...
import 'yield_prediction_page.dart';
import 'crop_recommend_page.dart';
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: JaikissanTheme.emerald.withOpacity(0.35),
              blurRadius: 24,
            ...
            return GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  color: selected
                      ? JaikissanTheme.beige.withOpacity(0.18)
                      : Colors.transparent,
                  ...
                  children: [
                    Icon(
                      ...
                      color: selected
                          ...
                          : JaikissanTheme.beige.withOpacity(0.4),
                      size: 22,
                    ),
                    if (selected) ...[
