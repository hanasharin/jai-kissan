...
class Dashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        fit: StackFit.expand,
        children: [
          // 2.0: full background image
          Image.asset('assets/images/emarald.jpg', fit: BoxFit.cover),
          // Light beige-tinted overlay so content is readable but image shows through
          Container(color: JKTheme.beigeLight.withOpacity(0.82)),
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style: Theme.of(
                    context,
                  ).textTheme.bodyMedium?.copyWith(color: JKTheme.inkLight),
                ),
  ...
  Widget _buildWeatherBanner(BuildContext context) {
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          // 2.0: solid emerald instead of gradient
          color: JKTheme.emerald,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            fontFamily: 'Poppins',
                            color: JKTheme.beige.withOpacity(0.55),
                            fontSize: 13,
                          ),
                        ),
                      ),
  ...
  Widget _buildModuleGrid(BuildContext context) {
    return Padding(
      ...
      child: Column(
        children: [
          // Hero module — Yield Prediction (1.0 large card, 2.0 emerald fill)
          _ModuleCard(
            title: 'Yield Prediction',
            subtitle: 'LSTM · GRU · Transformer',
            description:
                'Forecast expected yield using time-series deep learning on rainfall, temperature and soil data.',
...
class _WeatherPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Row(
      ...
      children: [
        Icon(icon, color: JKTheme.beige.withOpacity(0.6), size: 13),
...
class _SmallModuleCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final isSand = color == JKTheme.sand;
    return GestureDetector(
      onTap: onTap,
      child: Container(
        padding: const EdgeInsets.all(20),
        ...
        child: Column(
          ...
          children: [
            Icon(
              icon,
              color: isSand ? JKTheme.emerald : JKTheme.beige,
              size: 26,
            ),
            const SizedBox(height: 16),
            Text(
            ...
            Icon(
              Icons.arrow_forward_rounded,
              color: (isSand ? JKTheme.emerald : JKTheme.beige).withOpacity(
                0.5,
              ),
              size: 18,
            ),
