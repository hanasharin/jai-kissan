...
class _MarketPricePageState extends State<MarketPricePage> {
    ...
    return Scaffold(
      body: Stack(
        ...
        children: [
          ...
          Container(color: JaikissanTheme.beigeLight.withValues(alpha: 0.88)),
          SafeArea(
            child: Column(
              children: [
                // Custom app bar
                            ...
                            Row(
                              children: [
                                Icon(
                                  ...
                                  size: 13,
                                  color: JaikissanTheme.inkLight.withValues(
                                    alpha: 0.5,
                                  ),
                                ),
  ...
  Widget _buildForecastCard(BuildContext context) => JaikissanCard(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: JaikissanTheme.emerald.withValues(alpha: 0.1),
                borderRadius: BorderRadius.circular(20),
                border: Border.all(
                  color: JaikissanTheme.emerald.withValues(alpha: 0.25),
                ),
              ),
              child: Text(
                _selectedCrop,
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPath(
      ...
      Paint()
        ..shader = LinearGradient(
          ...
          colors: [
            JaikissanTheme.emeraldLight.withValues(alpha: 0.2),
            JaikissanTheme.emeraldLight.withValues(alpha: 0),
          ],
    ...
    for (var i = 0; i < data.length; i++) {
      canvas.drawCircle(
        ...
        4.5,
        Paint()..color = JaikissanTheme.beige,
      );
      canvas.drawCircle(
        Offset(px(i), py(data[i])),
        3,
        Paint()..color = JaikissanTheme.emeraldLight,
      );
      final tp = TextPainter(
        text: TextSpan(
          text: days[i % 7],
