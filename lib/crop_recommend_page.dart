...
class _CropResultCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isTop = rank == 1;
    return JaikissanCard(
      color: isTop ? JaikissanTheme.emerald : JaikissanTheme.beige,
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(
              result.icon,
              color: isTop ? JaikissanTheme.beige : result.color,
              size: 22,
            ),
          ),
              ...
              children: [
                  ...
                  children: [
                    ...
                    if (isTop) ...[
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: JaikissanTheme.sand.withOpacity(0.3),
                ...
                ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    ...
                    minHeight: 5,
                    backgroundColor:
                        (isTop ? JaikissanTheme.beige : result.color)
                            .withOpacity(0.15),
                    valueColor: AlwaysStoppedAnimation<Color>(
                      isTop
                          ? JaikissanTheme.beige.withOpacity(0.7)
                          : result.color,
                    ),
                  ),
                ),
          ...
          Text(
            ...
            style: TextStyle(
              ...
              fontWeight: FontWeight.w700,
              fontSize: 16,
              color: isTop ? JaikissanTheme.beige : JaikissanTheme.ink,
            ),
          ),
        ],
      ),
